    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="absolute right-4 overflow-hidden w-full h-full">
                    <Image src="/PhooRes/Building/Image.png" alt="background" fill className="object-cover opacity-90" />
                    <div className="absolute inset-0  bg-[#fffaf0] mix-blend-overlay opacity-80" />
                </div>
                <div className="relative z-10 flex flex-col items-center justify-center w-full h-full px-3 pt-10 pb-4">
                    ...
                    {links.map((link) => (
                        <Link
                            ...
                            className="mt-12"
                        >
                            <Button className="scale-[0.70] origin-top">
                                {link.buttonText}
                            </Button>
                        </Link>
                    ))}
