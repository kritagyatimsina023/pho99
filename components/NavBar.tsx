            ...
            <div className=" w-full flex  mt-10">
              ...
              <div className="flex items-start gap-4  w-full flex-col justify-between">
                ...
                <div className="flex items-center gap-2.5 group cursor-pointer">
                  ...
                  <div className="flex flex-col">
                    <span className="text-white! text-[10px] uppercase tracking-widest leading-none mb-0.5">Call</span>
          ...
          <div className="w-[45%] h-[65%] bg-transparent! rounded-[24px] flex flex-col items-center justify-center gap-3 overflow-hidden relative">
            ...
            <div className="w-full px-3 py-2 flex flex-col gap-3">
              {locationData.map(location => (
                <Link href={location.HREF} target='_blank' key={location.id} className="flex hover:bg-red-700/20 group items-center justify-between overflow-hidden gap-3 p-3 border border-red-400 rounded-xl transition-all cursor-pointer group bg-white/10">
                  ...
                  {/* Location Text */}
                  {/* <MapPin /> */}
                  <span className='text-white! translate-x-40 group-hover:translate-x-0 text-sm! transition-all duration-300 ease-in-out whitespace-nowrap' >Order Now</span>
                </Link>
              ))}
            </div>
