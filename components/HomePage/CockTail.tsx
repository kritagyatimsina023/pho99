          ...
          <div ref={contentWrapper} className="flex flex-col items-center px-4 md:px-8" >
            <div>
              <Heading ref={headingRef} className="text-center md:text-7xl! opacity-0.45">
                Signature cocktails paired with <span className="red-touch" >
                  authentic Vietnamese
                </span>  flavors
              </Heading>
            </div>
            <p className="text-center md:text-start max-w-xs text-para-secondary text-lg leading-[1.1] mt-4 md:mt-0">
          ...
          <div ref={drinksWrapper} className="h-[100vh] w-full">
            <div className="relative w-full flex flex-col overflow-hidden items-center mt-10">
              ...
              <div className="relative z-10 w-[90vw] md:w-[560px] max-w-[560px] border-b-2 border-transparent">
                ...
                <div className="absolute z-20 w-screen h-[1200px] bottom-[5%] left-1/2 -translate-x-1/2 overflow-hidden pointer-events-none mix-blend-difference  ">
                  <div className="absolute bottom-0 w-full flex items-center justify-center">
                    {drinks.map((drink, i) => (
                      <Heading
                        key={drink.id}
                        ref={(el) => { titleRefs.current[i] = el }}
                        className="absolute text-4xl! md:text-7xl! invert-50  lg:text-6xl! z-20 uppercase text-center whitespace-nowrap leading-none tracking-tight"
                      >
                        {drink.title}
                      </Heading>
                    ))}
            ...
            <div className="relative max-w-[350px] mx-auto mt-4 h-[60px]">
              {drinks.map((drink, i) => (
                <div
                  key={drink.id}
                ...
                >
                  <p className="text-center text-sm! md:text-lg! leading-[1.1] px-4">
                    {drink.desc}
                  </p>
                </div>
              ))}
