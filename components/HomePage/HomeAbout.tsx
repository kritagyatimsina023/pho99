...
const HomeAbout = () => {
  ...
  return (
    ...
    >
      {/* Top center text */}
      <div className="flex relative z-20 flex-col items-center max-w-5xl mx-auto mt-4 gap-6">
        <div className="w-full" ref={mainRef}>
          <Heading ref={mainHeading} className=" md:text-7xl! w-full text-center" >Experience our journey of <span className="red-touch" >
            bringing   Authentic,
          </span> Flavors Excellence &  Warm <br /> Hospitality</Heading>
        </div>
