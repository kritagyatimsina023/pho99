...
const NewChefInfo = () => {
    ...
    useGSAP(() => {
        ...
        tlTwo.to(detailRef.current, {
            ...
            .to(detailRef.current, { opacity: 0, y: -scrollDistance - 100, duration: 1.5 }, 5)
    ...
    return (
        <div ref={mainRef} className="h-[400vh] overflow-hidden" >
            <section ref={sectionRef} className="h-screen w-full relative z-10 " >
                ...
                <div ref={detailRef} className="bg-transparent absolute top-0 left-0 w-full z-10 mb-12" >
                    ...
                    <div className="w-full flex flex-col items-center justify-center relative" >
                        <div className="absolute z-30 left-[20%] top-[50%]" >
                            <p ref={firstQuote} className="heading-secondary text-5xl italic" >
                                ‘I don't just cook</p>
                        </div>
                        <div className="absolute z-30 right-[20%] top-[60%] flex flex-col items-end" >
                            <p ref={secondQuote} className="heading-secondary font-heading text-5xl italic" >
                                I script with fish
                            </p>
                            <span ref={thirdQuote} className="heading-secondary text-5xl italic">and salt‘</span>
                        </div>
                ...
                <div ref={detailRef2} className="bg-transparent absolute top-0 left-0 w-full z-10 mb-12 opacity-0" >
                    ...
                    <div className="w-full flex flex-col items-center justify-center relative" >
                        <div className="absolute z-30 left-[20%] top-[50%]" >
                            <p ref={firstQuote2} className="heading-secondary text-5xl italic" >
                                ‘Cooking is an art</p>
                        </div>
                        <div className="absolute z-30 right-[20%] top-[60%] flex flex-col items-end" >
                            <p ref={secondQuote2} className="heading-secondary font-heading text-5xl italic" >
                                I paint with spices
                            </p>
                            <span ref={thirdQuote2} className="heading-secondary text-5xl italic">and passion‘</span>
                        </div>
                        <div className="relative" >
