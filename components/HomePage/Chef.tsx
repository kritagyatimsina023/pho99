    ...
    <div ref={mainRef} className="h-[400vh] relative" >
      <section data-theme={"dark"} ref={sectionRef} className="h-screen w-full relative z-10 " >
        ...
        <div ref={detailRef} className="bg-transparent absolute inset-0 flex flex-col justify-center items-center w-full z-10 mb-12" >
          ...
          <Heading ref={headingRef} className="text-center heading-secondary py-5" >Chef <span className="red-touch" >Sangdorje
          </span>  tamang</Heading>
          <div className="w-full flex flex-col items-center justify-center relative" >
            ...
            <div className="absolute z-30 right-[20%] top-[60%] flex flex-col items-end" >
              ...
              <span ref={thirdQuote} className="heading-secondary text-3xl md:text-5xl italic font-melfira red-touch">and salt‘</span>
            </div>
        ...
        <div ref={detailRef2} className="bg-transparent absolute inset-0 flex flex-col justify-center items-center w-full z-10 mb-12 opacity-0" >
          ...
          <Heading ref={headingRef2} className="text-center heading-secondary" >Chef <span className="red-touch" >
            Pemba
          </span>  Tamang</Heading>
          <div className="w-full flex flex-col items-center justify-center relative" >
            <div className="absolute z-30 left-[20%] top-[50%]" >
