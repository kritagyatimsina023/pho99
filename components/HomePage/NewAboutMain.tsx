    ...
    >
      ...
      <div className="flex relative z-20 flex-col items-center max-w-2xl mx-auto mt-4 gap-6">
        ...
        <div className="flex flex-col items-center gap-3" >
          ...
          <Button className="px-8 py-3 border text-white! rounded-lg bg-primary!   font-semibold transition-colors cursor-pointer">
            About Us
          </Button>
        </div>
      </div>
      ...
      <div className="hidden lg:block absolute right-12 xl:right-32 top-[calc(320px+35vw+20px)]  w-32 h-32 z-20">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-12 h-12 bg-[#78e42a] rounded-full flex items-center justify-center shadow-md">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 6h16M5 6v12M19 6v12M10 6v6M14 6v6" /></svg>
          </div>
        </div>
      </div>
