  ...
  return <section ref={sectionRef} className="w-full min-h-screen relative z-10 overflow-hidden">
    ...
    >
      <div className="absolute inset-0 w-full h-full pointer-events-none">
        ...
        {/* Top-left tall photo */}
        <div ref={(el) => { imgWrapperRefs.current[0] = el }} className="absolute top-4 left-4 md:top-8 md:left-8 w-[120px] md:w-[200px] h-[160px] md:h-[240px] rounded-2xl overflow-hidden rotate-[-4deg] shadow-xl">
        ...
        {/* Bottom-left */}
        <div ref={(el) => { imgWrapperRefs.current[4] = el }} className="absolute hidden md:block bottom-6 left-6 md:bottom-12 md:left-24 w-[140px] md:w-[200px] h-[160px] md:h-[220px] rounded-2xl overflow-hidden rotate-[4deg] shadow-xl">
        ...
        {/* Bottom-right large */}
        <div ref={(el) => { imgWrapperRefs.current[6] = el }} className="absolute hidden md:block bottom-4 right-4 md:bottom-8 md:right-24 w-[150px] md:w-[210px] h-[180px] md:h-[240px] rounded-2xl overflow-hidden rotate-[-4deg] shadow-xl">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 90% 70% at 50% 50%, rgba(255,255,255,1) 10%, rgba(255,255,255,0.85) 10%, rgba(255,255,255,0) 80%)",
          }}
        />
      </div>
      <div className="relative z-20 max-w-3xl  mx-auto flex flex-col items-center justify-center min-h-screen py-30 px-4">
        {/* Pill label */}
        <Heading
          ref={headingRef}
          className="text-center text-5xl! md:text-7xl! text-transparent-heading font-heading-arial"
        >
          Taste Authentic <span className="red-touch" >
            Cuisine <br /> Crafted
          </span>  With Every Order
        </Heading>
        <p
          ref={paraRef}
