...
const Reservation = () => {
  ...
  return <section ref={sectionRef} className="w-full min-h-screen relative z-10 overflow-hidden">
    <div className="absolute inset-0 z-10">
      <Image ref={imgRef} alt="banner-img" fill className="object-contain" src={"/Hero/NewFlowerBanner.png"} />
    </div>
    <div
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none">
        ...
        {/* Top-left tall photo */}
        <div ref={(el) => { imgWrapperRefs.current[0] = el }} className="absolute top-8 left-8 w-[180px] h-[240px] rounded-2xl overflow-hidden rotate-[-4deg] shadow-xl">
          <Image src="/Hero/Food/food-1.jpg" alt="" fill className="object-cover" />
        </div>

        {/* Top-left second photo */}
        <div ref={(el) => { imgWrapperRefs.current[1] = el }} className="absolute top-32 left-52 w-[140px] h-[160px] rounded-2xl overflow-hidden rotate-[3deg] shadow-lg">
          <Image src="/Hero/Food/food-2.jpg" alt="" fill className="object-cover" />
        </div>

        {/* Top-right large photo */}
        <div ref={(el) => { imgWrapperRefs.current[2] = el }} className="absolute top-6 right-10 w-[200px] h-[260px] rounded-2xl overflow-hidden rotate-[5deg] shadow-xl">
          <Image src="/Hero/Food/food-3.jpg" alt="" fill className="object-cover" />
        </div>

        {/* Top-right small */}
        <div ref={(el) => { imgWrapperRefs.current[3] = el }} className="absolute top-36 right-56 w-[130px] h-[150px] rounded-2xl overflow-hidden rotate-[-3deg] shadow-lg">
          <Image src="/Hero/Food/food-4.jpg" alt="" fill className="object-cover" />
        </div>

        {/* Bottom-left */}
        <div ref={(el) => { imgWrapperRefs.current[4] = el }} className="absolute bottom-12 left-24 w-[200px] h-[220px] rounded-2xl overflow-hidden rotate-[4deg] shadow-xl">
          <Image src="/PhooRes/Building/heroBuildingOne.jpg" alt="" fill className="object-cover" />
        </div>

        {/* Bottom-left second */}
        <div ref={(el) => { imgWrapperRefs.current[5] = el }} className="absolute bottom-50 left-52 w-[150px] h-[160px] rounded-2xl overflow-hidden rotate-[-5deg] shadow-lg">
          <Image src="/PhooRes/Building/Jhamsikhel.jpg" alt="" fill className="object-cover" />
        </div>

        {/* Bottom-right large */}
        <div ref={(el) => { imgWrapperRefs.current[6] = el }} className="absolute bottom-8 right-24 w-[210px] h-[240px] rounded-2xl overflow-hidden rotate-[-4deg] shadow-xl">
          <Image src="/PhooRes/Building/Bouddha.jpg" alt="" fill className="object-cover" />
        </div>

        {/* Bottom-right small */}
        <div ref={(el) => { imgWrapperRefs.current[7] = el }} className="absolute bottom-50 right-50 w-[140px] h-[155px] rounded-2xl overflow-hidden rotate-[3deg] shadow-lg">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 55% 60% at 50% 50%, rgba(255,255,255,1) 10%, rgba(255,255,255,0.85) 30%, rgba(255,255,255,0) 90%)",
          }}
        />
      </div>
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen py-30 px-4">
        ...
        <Heading
          ref={headingRef}
          className="text-center text-7xl! text-transparent-heading font-heading-arial"
        >
